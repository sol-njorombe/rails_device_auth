...
RSpec.describe Admin::AdminsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new admin_admin" do

        post :create, params: {admin_admin: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(admin_admin_url(Admin::Admin.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new admin_admin" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the admin_admin" do
        admin = Admin::Admin.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the admin_admin" do
        admin = Admin::Admin.create! valid_attributes
